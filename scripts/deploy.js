...
async function main() {
  ...
  const stakingRewardsERC721 = await StakingRewardsERC721.deploy(cryptoFrens.address, happy.address, 100);
  ...
  const stakingRewardsERC20 = await StakingRewardsERC20.deploy(poolAddress, happy.address, 900);
